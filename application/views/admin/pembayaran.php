    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        ?>
            ...
            ?>
                ...
                <button class="btn btn-primary" onclick="toggleTable()">Data Without Transfer Prove</button>
                <button class="btn btn-primary" onclick="toggleTable2()">Data With Transfer Prove</button>
                <button class="btn btn-primary" onclick="toggleTable3()">Data With Confirmed Prove</button>
                <br><br><br>


                <!-- Hoverable Table rows -->
                <div class="card" id="tabel1" style="display: none;">
                    <h5 class="card-header">Data Without Transfer Prove</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="<?= base_url(); ?>C_Admin/konfirmasi_pembayaran/<?= $strk['id_pembayaran'] ?>" onclick="return confirm('Apakah Anda yakin ingin mengkonfirmasi pembayaran?')"><i class="bx bx-check me-1"></i> Confirm</a>
                ...
                <div class="card" id="tabel3" style="display: none;">
                    <h5 class="card-header">Data With Confirmed Prove</h5>
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover">
                            <thead>
                                <tr>
